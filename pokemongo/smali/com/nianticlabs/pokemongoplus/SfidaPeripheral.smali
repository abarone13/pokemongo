...
.method private onBondStateChanged(Landroid/content/Intent;)V
    ...
    const-string v5, "Tid: %d onBondStateChanged()"
    ...
    .line 551
    invoke-static {v3}, Lcom/nianticlabs/pokemongoplus/SfidaUtils;->getBondStateName(I)Ljava/lang/String;
    ...
    .line 553
    invoke-static {v6}, Lcom/nianticlabs/pokemongoplus/SfidaUtils;->getBondStateName(I)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/nianticlabs/pokemongoplus/SfidaPeripheral;->bluetoothDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    const-string v6, "BOND_NONE, disconnecting from bonding, state = "
    ...
    sget-object v5, Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;->Connecting:Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;

    if-eq v4, v5, :cond_2

    iget-object v4, p0, Lcom/nianticlabs/pokemongoplus/SfidaPeripheral;->state:Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;

    sget-object v5, Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;->Connected:Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;

    if-ne v4, v5, :cond_0

    .line 587
    :cond_2
    invoke-direct {p0, v1}, Lcom/nianticlabs/pokemongoplus/SfidaPeripheral;->disconnectFromBonding(Landroid/bluetooth/BluetoothDevice;)V
    ...
    const-string v6, "BOND_BONDED, state = "
    ...
    sget-object v5, Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;->Disconnected:Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;

    if-eq v4, v5, :cond_0

    iget-object v4, p0, Lcom/nianticlabs/pokemongoplus/SfidaPeripheral;->state:Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;

    sget-object v5, Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;->Disconnecting:Lcom/nianticlabs/pokemongoplus/ble/SfidaConstant$PeripheralState;
    ...
    const-string v6, "BOND_BONDED, retrying, state = "
    ...
    .line 575
    invoke-direct {p0, v1}, Lcom/nianticlabs/pokemongoplus/SfidaPeripheral;->reconnnectFromBonding(Landroid/bluetooth/BluetoothDevice;)V
    ...
    .line 590
    invoke-direct {p0, v1}, Lcom/nianticlabs/pokemongoplus/SfidaPeripheral;->bondingCanceled(Landroid/bluetooth/BluetoothDevice;)V
    ...
    const-string v6, "BOND_NONE, bonding canceled, state = "
...
.method private onPairingRequest(Landroid/bluetooth/BluetoothDevice;)V
    ...
    const-string v3, "Tid: %d onPairingRequest()"
    ...
    const-string v3, "onPairingRequest()"
